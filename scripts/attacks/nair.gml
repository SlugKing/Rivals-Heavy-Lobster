...
set_attack_value(AT_NAIR, AG_HURTBOX_SPRITE, sprite_get("airbox"));
...
set_window_value(AT_NAIR, 1, AG_WINDOW_SFX, sound_get("nair_paint"));
...
set_hitbox_value(AT_NAIR, 1, HG_HIT_SFX, asset_get("sfx_waterhit_weak"));
...
set_hitbox_value(AT_NAIR, 2, HG_HIT_SFX, asset_get("sfx_waterhit_weak"));
...
set_hitbox_value(AT_NAIR, 3, HG_HIT_SFX, asset_get("sfx_waterhit_weak"));
