...
//set_window_value(AT_NSPECIAL, 2, AG_WINDOW_SFX, sound_get("fireball"));
//set_window_value(AT_NSPECIAL, 2, AG_WINDOW_SFX_FRAME, 1);
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, .025);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_HITBOX_Y, 8);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_HITSTUN_MULTIPLIER, 0.001);
