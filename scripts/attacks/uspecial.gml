...
set_attack_value(AT_USPECIAL, AG_HURTBOX_SPRITE, sprite_get("airbox"));
...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_SFX, sound_get("jet_upb"));
...
//set_window_value(AT_USPECIAL, 5, AG_WINDOW_SFX, sound_get("boom"));
