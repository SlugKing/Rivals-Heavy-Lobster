...
set_attack_value(AT_UAIR, AG_HURTBOX_SPRITE, sprite_get("airbox"));
...
set_hitbox_value(AT_UAIR, 1, HG_ANGLE, 20);
set_hitbox_value(AT_UAIR, 1, HG_BASE_KNOCKBACK, 6);
set_hitbox_value(AT_UAIR, 1, HG_KNOCKBACK_SCALING, .40);
...
set_hitbox_value(AT_UAIR, 1, HG_VISUAL_EFFECT_X_OFFSET, 24);